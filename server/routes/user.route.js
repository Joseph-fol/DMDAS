...
const {userSignup, userSignin, requestPinReset, resetPinWithOTP, addManual, getRepManuals, resetPasswordSetting, initializeTransaction, verifyTransaction, editManual} = require("../controllers/user.controller")
...
router.put("/rep/editManual", verifyToken, isRep, editManual)
