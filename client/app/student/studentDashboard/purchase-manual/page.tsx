  ...
  return (
    <div className="py-2">
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          <h1 className="text-2xl font-semibold text-slate-900">Purchase Manual</h1>
          <p className="mt-2 text-sm text-slate-600">Select a manual and pay securely via Paystack. Your keycode is generated instantly.</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-4 mb-6 overflow-x-auto">
          <div className="flex items-center gap-6 min-w-[640px]">
            <div className="flex items-center gap-4 whitespace-nowrap">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-red-500 text-white font-medium">1</div>
            ...
            <div className="flex items-center gap-4 text-slate-400 whitespace-nowrap">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-100 text-slate-400">2</div>
              <div className="text-sm">Pay with Paystack</div>
            </div>
            <div className="flex-1 h-0.5 bg-slate-200" />
            <div className="flex items-center gap-4 text-slate-400 whitespace-nowrap">
              <div className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-100 text-slate-400">3</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="col-span-1 md:col-span-8">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <h3 className="text-lg font-semibold text-slate-800">Step 1 — Select Manual</h3>
              <p className="mt-2 text-sm text-slate-600">Choose a Course Manual</p>
                  ...
                  <div className="mt-6">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div className="bg-slate-50 rounded-md p-4 text-sm">
                        ...
                        <div className="mt-2 font-medium text-slate-800">{selected.department}</div>
                      </div>

                      <div className="bg-slate-50 rounded-md p-4 text-sm">
                        <div className="text-xs text-slate-400 uppercase">Level</div>
                        <div className="mt-2 font-medium text-slate-800">{selected.level}</div>
                      </div>

                      <div className="bg-red-50 rounded-md p-4 text-sm">
                        <div className="text-xs text-red-400 uppercase">Price</div>
                        <div className="mt-2 font-semibold text-red-600">{formatCurrency(selected.price)}</div>
                      </div>
                    </div>
                  </div>
                )}
            ...
            {selected && (
              <div className="bg-white rounded-xl shadow-sm p-6 mt-6">
                <h3 className="text-lg font-semibold text-slate-800">Step 2 — Pay with Paystack</h3>
                <p className="mt-2 text-sm text-slate-600">Secure payment powered by Paystack. Supports card, bank transfer, and USSD. Your keycode is issued immediately after payment.</p>
                ...
                <div className="mt-6 bg-slate-50 rounded-md p-4 flex items-center justify-between">
                  <div>
                    ...
                    <div className="mt-2 text-2xl font-bold text-slate-900">{formatCurrency(selected.price)}</div>
                  </div>
          ...
          <div className="col-span-1 md:col-span-4 space-y-6 md:sticky md:top-28">
            <div className="bg-white rounded-xl shadow-sm p-4">
              ...
              <ul className="mt-3 space-y-3 text-sm text-slate-600">
                <li className="flex items-start gap-3"><span className="text-slate-400">📚</span> Select your manual from the list</li>
                <li className="flex items-start gap-3"><span className="text-slate-400">💳</span> Pay securely via Paystack</li>
                <li className="flex items-start gap-3"><span className="text-slate-400">🔑</span> Get your keycode instantly</li>
                <li className="flex items-start gap-3"><span className="text-slate-400">📦</span> Present keycode to collect manual</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 text-sm text-slate-600">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-sm">Your keycode is generated the moment payment is confirmed — no manual approval needed. No waiting.</div>
                </div>
              </div>
            </div>
          </div>
